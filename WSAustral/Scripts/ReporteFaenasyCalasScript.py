...
# url = r"P:\Extraccion Calas - Jorge Castillo"
...
# url += "\PDF REPORTE DE CALA"
# ld = os.listdir(url)
# for anio in ld:
#     if anio != "CHD":
#         print(anio)
#         for mes in os.listdir(os.path.join(url, anio)):
#             urltemp = os.path.join(url, anio)
#             print("\t", mes)
#             for dia in os.listdir(os.path.join(urltemp, mes)):
#                 print("\t\t", dia)
#                 urltemp2 = os.path.join(urltemp, mes)
#                 for op_planta in os.listdir(os.path.join(urltemp2, dia)):
#                     print("\t\t\t", op_planta)
    ...
    for it in files:
        try:
            ...
            for file in os.listdir(url + "\\" + str(it[:-4])):
                try:
                    # os.remove(url + "\\" + str(it[:-4]) + "\\" + file)
                    os.remove(os.path.join(url, str(it[:-4]), file))
                except:
                    continue
            try:
                # print(os.path.join(url, str(it[:-4])))
